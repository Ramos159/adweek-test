...
function Edit({
  ...
  const postCategories = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    return select('core').getEntityRecords('taxonomy', 'category');
  });
  // get the category to display the name later
  const chosenCategory = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    return select('core').getEntityRecords('taxonomy', 'category', {
      include: certainPostCategory
    });
  });
  let categoryOptions = [];
  ...
  const posts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    ...
    if (certainPostCategory) {
      ...
      return select('core').getEntityRecords('postType', 'post', {
        per_page: numberOfPostsToDisplay,
        categories: certainPostCategory
      });
    } else {
      return select('core').getEntityRecords('postType', 'post', {
        per_page: numberOfPostsToDisplay
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    onChange: value => {
      if (value == "") {
        ...
        setAttributes({
          numberOfPostsToDisplay: parseInt(value)
        });
      }
    }
    ...
    onChange: category => setAttributes({
      certainPostCategory: parseInt(category)
    })
    ...
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Latest ", chosenCategory && chosenCategory[0].name, " Blogs"), !posts && "No Posts", posts && posts.length > 0 && posts.map(post => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      style: styles.blogListOuter
    }, showPostThumbnail ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      style: post.featured_image_src ? {
        width: "33.33%",
        backgroundImage: `url(${post.featured_image_src})`,
        backgroundPosition: "center",
        backgroundSize: "cover"
      } : styles.imageNotAvailable
    }, post.featured_image_src ? null : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      style: {
        textAlign: "center"
      }
    }, "No Featured Image")) : null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      style: showPostThumbnail ? styles.blogContentSmall : null
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: post.link,
      target: "_blank"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, post.title.rendered)), (0,html_react_parser__WEBPACK_IMPORTED_MODULE_5__["default"])(post.excerpt.rendered), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "By ", post.author_info.display_name))));
  })));
}
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/blog-list-block","version":"0.1.0","title":"Blog List Block","category":"widgets","description":"A list of Blog entries with some settings for customization","example":{},"supports":{"html":false},"attributes":{"numberOfPostsToDisplay":{"type":"integer","default":1},"certainPostCategory":{"type":"integer","default":0},"showPostThumbnail":{"type":"boolean"}},"textdomain":"blog-list-block","editorScript":"file:./index.js","render":"file:./render.php","editorStyle":"file:./build/index.css","style":"file:./build/style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkblog_list_block"] = globalThis["webpackChunkblog_list_block"] || [];
